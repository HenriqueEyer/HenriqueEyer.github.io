...
//   Calcule a média de idade das pessoas quando seus 
//   respectivos livros foram lançados.
//     Dica: Utilize a função reduce

    const number = (objcetBook) => objcetBook.releaseYear -objcetBook.author.birthYear;
    const reducer = (accumulator, currentValue) => accumulator + number(currentValue);

    const value = books.reduce(reducer,0);
